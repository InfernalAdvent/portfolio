        ...
        <div>
            <section className="portfolio-title">
                ...
                <div className="container-title my-5 mx-auto">
                    <h1 className="mb-2"><strong>Portfolio</strong></h1>
            ...
            <section className="portfolio-cards">
                <div className="container my-5 py-4">
                    <div className="row gy-4 justify-content-center"> {/* Centrage des cartes */}
                    
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/fresh-food.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>Fresh Food</strong></h4>
                    ...
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/restaurant-japonais.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>Restaurant Akira</strong></h4>
                    ...
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/espace-bien-etre.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>Espace bien-être</strong></h4>
                    ...
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/seo.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>SEO</strong></h4>
                    ...
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/coder.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>Création d'une API</strong></h4>
                    ...
                    <div className="col-12 col-md-4 col-lg-4 d-flex justify-content-center">
                        <div className="card w-100">
                        <img src="/images/portfolio/screens.jpg" className="card-img-top" alt="..." />
                        <div className="card-body">
                            <h4 className="card-title"><strong>Maquette d'un site web</strong></h4>
